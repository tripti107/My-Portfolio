  ...
  const projects = [
    {
      ...
      description:
        "Interactive tic-tac-toe game with clean UI, game state management, and winner detection. Features responsive design and smooth animations.",
      ...
      repoUrl: "https://github.com/tripti107/tic-tac-toe-game.git",
      demoUrl: "https://tripti107.github.io/tic-tac-toe-game/",
    },
    {
      id: 2,
      title: "Live Music Streaming App",
      description:
        "Music streaming application with playlist management, audio controls, and real-time playback. Clean interface with modern design patterns.",
      ...
      repoUrl:
        "https://github.com/tripti107/live-music-streaming-application.git",
      demoUrl: "https://tripti107.github.io/live-music-streaming-application/",
    },
    {
      id: 3,
      title: "Todo Application",
      description:
        "Task management app with CRUD operations, local storage, and intuitive user interface. Features task categorization and completion tracking.",
      ...
      repoUrl: "https://github.com/tripti107/my-todo-app.git",
      demoUrl: "https://tripti107.github.io/my-todo-app/",
    },
    {
      id: 4,
      title: "E-commerce Website",
      description:
        "Full-featured e-commerce platform with product catalog, shopping cart, and responsive design. Includes product filtering and modern checkout flow.",
      ...
      repoUrl: "https://github.com/tripti107/ecommerce-website.git",
      demoUrl: "https://tripti107.github.io/ecommerce-website/",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            A showcase of my frontend development projects demonstrating various
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              These projects represent my journey as a frontend developer. I'm
